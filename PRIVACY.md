...
EasyCut is a desktop application for downloading YouTube videos and converting audio. This privacy policy explains how we handle your data.
...
- **FFmpeg**: Open-source media processing (runs locally, no data collection)
