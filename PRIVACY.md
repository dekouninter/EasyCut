...
- **FFmpeg**: Used by yt-dlp for media muxing and post-processing (runs locally, no data collection)
- **pywinstyles**: Windows visual effects library (local-only, no data collection)
- **darkdetect**: OS theme detection (local-only, no data collection)
